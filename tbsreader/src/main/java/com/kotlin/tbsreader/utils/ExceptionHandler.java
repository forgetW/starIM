...
public class ExceptionHandler implements Thread.UncaughtExceptionHandler {
    ...
    public static String fileDownloadPath = Environment.getExternalStorageDirectory().getAbsolutePath();
    public static String savePath = fileDownloadPath + "/com.wit.cqgzy";
//    public static String fileDownloadPath = "data/data/com.wit.cqgzw";
    ...
    public void initConfig(Context context) {
        ...
        saveSpacePath = new File(fileDownloadPath,"/Download");
//        saveSpacePath = new File(Environment.getExternalStorageDirectory().getAbsolutePath(),"/Download");
