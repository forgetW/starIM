...
public class MiPushManager implements QPushManager {
    public static final String NAME = Constants.NAME_XIAOMI;
    ...
    public void registerPush(Context context) {
        ...
        Log.i("IM_LOG","注册小米推送 registerPush appId : " + appId + "  appKey : " + appKey + "  regid : " + MiPushClient.getRegId(context));
    }

    @Override
    public void unRegisterPush(Context context) {
        Log.i("IM_LOG","注销小米推送 unRegisterPush  appId : " + appId + "  appKey : " + appKey + "  regid : " + MiPushClient.getRegId(context));
    ...
    public void setAlias(Context context, String alias) {
        Log.i("IM_LOG","注册小米推送 setAlias  " + "regid : " + MiPushClient.getRegId(context));
