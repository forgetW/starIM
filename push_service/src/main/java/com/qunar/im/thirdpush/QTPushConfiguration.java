...
public class QTPushConfiguration {
    ...
    public static void initPush(final Context context) {
        ...
        QPushClient.addPushManager(new MiPushManager("2882303761518599998", "5781859963998"));  //temp
        QPushClient.addPushManager(new ThirdPushManager("2882303761518599998", "5781859963998")); //temp
        ...
        QPushClient.addPushManager(new HwPushManager("102368361", "CV8RbMo56bFKY/OR1D6UcuLDMpfxe4lz1HBe1yvUeOmaQNBmwH0V/ruq0k2QS6mVGUfP/XQiLWxOYt3YC+TfQA18WLRO"));
