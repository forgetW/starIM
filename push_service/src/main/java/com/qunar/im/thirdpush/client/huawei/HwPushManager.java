...
//                .addApi(HuaweiPush.PUSH_API)
                .addConnectionCallbacks(new HuaweiApiClient.ConnectionCallbacks() {
                    ...
                    public void onConnected() {
                        Log.i(TAG, "华为push连接成功");
                        getTokenAsyn();
                    }

                    @Override
                    public void onConnectionSuspended(int i) {
                        Log.i(TAG, "华为push连接 onConnectionSuspended");
                    }
                })
                .addOnConnectionFailedListener(new HuaweiApiClient.OnConnectionFailedListener() {
                    ...
                    public void onConnectionFailed(final ConnectionResult connectionResult) {
                        new Handler().postDelayed(new Runnable() {
                            ...
                            public void run() {
                                connectHuaweiClient(context);
                                Log.i(TAG, "华为push连接失败: " + (connectionResult != null ? connectionResult.getErrorCode() : "connectionResult为空"));
                            }
                        }, 30 * 1000);
                    }
                })
        ...
        Log.i(TAG, "华为建立连接" + "getAppID ：" + client.getAppID() + " : " + client.getCpID() + " ：" + getSingInfo(context, context.getPackageName().toString(), SHA256));
        client.connect((Activity) context);
    }

    @Override
    public void unRegisterPush(Context context) {
        Log.i(TAG, "注销华为推送 unRegisterPush" );
...
//                    Log.i(TAG, "华为push  getTokenAsyn ： " + result.getTokenRes().getToken());
//                }
//            }
//        });
    }
