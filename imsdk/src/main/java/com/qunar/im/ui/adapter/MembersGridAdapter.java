...
//                        });
//                    }
                    initUIPlus(holder.m_name1, holder.m_gravatar1, holder.ll_vertical_one);
                    break;
                case DEL_MEMBER:
                    initUIMinus(holder.m_name1, holder.m_gravatar1, holder.ll_vertical_one);
//                    holder.m_name1.setText("");
...
//                    loadView(holder.m_gravatar1, member.getJid());
            ...
            holder.ll_vertical_one.setVisibility(View.GONE);
...
//                        });
//                    }
                    initUIPlus(holder.m_name2, holder.m_gravatar2, holder.ll_vertical_two);
                    break;
                case DEL_MEMBER:
                    initUIMinus(holder.m_name2, holder.m_gravatar2, holder.ll_vertical_two);
//                    holder.m_name2.setText("");
...
//                                        ProfileUtils.displayGravatarByImageSrc(member.getMemberId(),headerSrc,holder.m_gravatar2);
            ...
            holder.ll_vertical_two.setVisibility(View.GONE);
...
//                        });
//                    }
                    initUIPlus(holder.m_name3, holder.m_gravatar3, holder.ll_vertical_three);
                    break;
                case DEL_MEMBER:
                    initUIMinus(holder.m_name3, holder.m_gravatar3, holder.ll_vertical_three);
//                    holder.m_name3.setText("");
...
//                                        ProfileUtils.displayGravatarByImageSrc(member.getMemberId(),headerSrc,holder.m_gravatar3);
            ...
            holder.ll_vertical_three.setVisibility(View.GONE);
        ...
        if (position * 4 + 3 < members.size()) {
            ...
            switch (member.getMemberId()) {
                case ADD_MEMBER:
                    initUIPlus(holder.m_name4, holder.m_gravatar4, holder.ll_vertical_four);
                    break;
                case DEL_MEMBER:
                    initUIMinus(holder.m_name4, holder.m_gravatar4, holder.ll_vertical_four);
                    break;
                default:
                    connectionUtil.getUserCard(member.getMemberId(), new IMLogicManager.NickCallBack() {
                        @Override
...
//                                        ProfileUtils.displayGravatarByImageSrc(member.getMemberId(),headerSrc,holder.m_gravatar4);
            ...
            holder.ll_vertical_four.setVisibility(View.GONE);
            holder.ll_vertical_four.setOnClickListener(null);
        }
    }

    private void initUIPlus(TextView m_name, SimpleDraweeView m_gravatar, LinearLayout ll_vertical) {
        m_name.setText("");
        m_gravatar.setImageResource(R.drawable.atom_ui_plus);
        m_gravatar.setContentDescription("group_add_members");
        m_name.setTag(null);
        if (addNewMemberListener != null) {
            ll_vertical.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    addNewMemberListener.onClick();
                }
        ...
        m_gravatar.setVisibility(View.GONE);
    }

    private void initUIMinus(TextView m_name, SimpleDraweeView m_gravatar, LinearLayout ll_vertical) {
        m_name.setText("");
        m_gravatar.setImageResource(R.drawable.atom_ui_ic_minus);
        m_gravatar.setContentDescription("group_delete_members");
        m_name.setTag(null);
        if (delMemberListener != null) {
            ll_vertical.setOnClickListener(new View.OnClickListener() {
                @Override
