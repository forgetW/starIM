...
public class EmotionDownloader {
    ...
    private String DEFAULT_URL = QtalkNavicationService.getInstance().getSimpleapiurl() + "/file/v1/emo/d/e/config?p=" + appName().toLowerCase();

    private String appName(){
        if (GlobalConfigManager.getAppName() != null) {
            return GlobalConfigManager.getAppName();
        }else {
            return "com.wit.cqgzy";
        }
    }
