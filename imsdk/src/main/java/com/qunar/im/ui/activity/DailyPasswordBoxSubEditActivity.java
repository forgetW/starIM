...
public class DailyPasswordBoxSubEditActivity extends SwipeBackActivity implements IDailyMindSubEditView {
    ...
    private void initView() {
        ...
        setActionBarTitle(null != dailyMindSub && null != dailyMindSub.title ? dailyMindSub.title : "");
        ...
        sub_name.setText(null != dailyMindSub && null != dailyMindSub.title ? dailyMindSub.title : "");
        try {
