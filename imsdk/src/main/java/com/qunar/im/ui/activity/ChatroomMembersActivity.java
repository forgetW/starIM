...
//                panelPresenter.topMessage();
        ...
        secondFooterView.findViewById(R.id.top_rl2).setVisibility(View.GONE);
        secondFooterView.findViewById(R.id.top_view_line).setVisibility(View.GONE);
        secondFooterView.findViewById(R.id.top_view).setVisibility(View.GONE);
        secondFooterView.findViewById(R.id.top_line).setVisibility(View.GONE);
        secondFooterView.findViewById(R.id.top_rl).setVisibility(View.GONE);
    }
    //初始化群独有功能
...
//                            presenter.leave();
    ...
    void showQRCOdeActivity() {
        Intent intent = new Intent(ChatroomMembersActivity.this, QRActivity.class);
    ...
    void cloud_record_of_chat() {
        ...
        Intent intent = new Intent(ChatroomMembersActivity.this, CloudChatRecordActivity.class);
