...
//        sendGroupAllRead(imMessage.getToID());
    ...
    public Nick getNickByJid(String jid){
        return IMLogicManager.getInstance().getNickByJidFromDb(jid);
    }
...
//                        imstat.bindString(14, "");
    ...
    public RecentConversation SelectConversation4Id(String realUser) {
        ...
        return IMDatabaseManager.getInstance().SelectConversation4Id(realUser);
    }
